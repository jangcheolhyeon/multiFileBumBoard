    ...
    <section id="content" class="content__body">
        <div class="cont">
            ...
            <div class="btnWrap">
                ...
                <div class="fr">
                    <a href="#this" class="btn btn-danger" onclick="deleteBoard()">삭제</a>
                    <a href="#this" class="btn btn-primary" onclick="updateBoard()">수정</a>
                </div>
            </div>
		...
		function deleteBoard(){
			...
			if(${isAdmin} == true){
				if(confirm("게시글을 삭제하겠습니까?") == true){
					let xhr = new XMLHttpRequest();
					xhr.open("Delete", "<c:url value="/board/"/>" + board_id + ".do");
					xhr.send();
